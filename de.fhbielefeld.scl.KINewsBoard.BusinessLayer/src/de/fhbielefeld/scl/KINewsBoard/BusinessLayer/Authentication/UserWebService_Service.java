 ...
 * 
 */
@WebServiceClient(name = "UserWebService", targetNamespace = "http://webservices.user.scl.fhbielefeld.de/", wsdlLocation = "http://gf01-ifm-min.ad.fh-bielefeld.de:8080/SCL_WebPresentation/UserWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERWEBSERVICE_QNAME = new QName("http://webservices.user.scl.fhbielefeld.de/", "UserWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://gf01-ifm-min.ad.fh-bielefeld.de:8080/SCL_WebPresentation/UserWebService?wsdl");
    ...
    public UserWebService getUserWebServicePort() {
        return super.getPort(new QName("http://webservices.user.scl.fhbielefeld.de/", "UserWebServicePort"), UserWebService.class);
    }
    ...
    public UserWebService getUserWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservices.user.scl.fhbielefeld.de/", "UserWebServicePort"), UserWebService.class, features);
    }
